...
import br.com.residencia.service.VendedorService;
...
public class VendedorController {
    ...
    public ResponseEntity<Page<Vendedor>> buscarPorFaixaSalarial(@RequestParam(defaultValue = "0") Double valorMinimo,
            @RequestParam(defaultValue = "3000") Double valorMaximo, Pageable pageable) {
        return ResponseEntity.ok(vendedorRepository.findBySalarioBetween(valorMinimo, valorMaximo, pageable));
    }

    @GetMapping("/nomes")
    public ResponseEntity<Page<Vendedor>> buscarPorNome(@RequestParam String paramNome, Pageable pageable) {
